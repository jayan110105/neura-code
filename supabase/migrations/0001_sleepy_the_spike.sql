...
ALTER TABLE "bookmarks" ADD COLUMN "user_id" text NOT NULL;--> statement-breakpoint
ALTER TABLE "notes" ADD COLUMN "user_id" text NOT NULL;--> statement-breakpoint
ALTER TABLE "reminders" ADD COLUMN "user_id" text NOT NULL;--> statement-breakpoint
